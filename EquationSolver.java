...
public class EquationSolver {
    ...
    public static double[] solveFirstDegreeEqSystemTwoVars() {
        ...
        String eq = coefficient[0] + "x + " + coefficient[1] + "y = " + coefficient[2] + "\n"
                + coefficient[3] + "x + " + coefficient[4] + "y = " + coefficient[5];
        System.out.println(eq);
    ...
    public static double[] solveSecondDegreeEqOneVar() {
        ...
        String eq = coefficient[0] + "x^2 + " + coefficient[1] + "x + " + coefficient[2] + " = " + 0;
        System.out.println(eq);
        ...
        if (discriminant >= 0) {
            ...
            if (root1 == root2) {
                System.out.printf("Solution: x1 = x2 = %2f", root1);
                return new double[]{root1};
            } else {
                System.out.printf("Solution: x1 = %2f; x2 = %2f", root1, root2);
